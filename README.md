...
## Створення галереї зображень і збереження даних форм.

### 1 - Галерея зображень
Використано бібліотеку SimpleLightbox https://www.npmjs.com/package/simplelightbox, яка повністю бере на себе обробку кліків по зображеннях, відкриття і закриття модального вікна, а також гортання зображень за допомогою клавіатури.
...
Додано у HTML розмітку форми. У JS написано скрипт, який буде зберігати значення полів у локальне сховище, коли користувач щось друкує.
